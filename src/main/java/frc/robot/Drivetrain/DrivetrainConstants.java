...
//-------------------------------------------------------------------SPEEDS-----------------------------------------------------------------------------------
    public static final double defaultDriveSpeed = 0.5; //default speed that will be used in meters/second
...
//-----------------------------------------------------STUFF TO TEST/ MESS WITH-----------------------------------------------------------------------------------
    ...
    public static final double multiplierConstant = 0.5;/*When the trapezoid profile is done the robot will fix position if it's off by too much
    the normalized vector for velocity will be multiplied by distance/thisVar in that case */
    public static final double rotMultiplierConstant = 0.5; //similar to the one above-ish but it's for rotation
